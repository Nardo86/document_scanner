...
class PdfGenerator {
      ...
      pdf.addPage(
        pw.Page(
          ...
          build: (pw.Context context) {
            return pw.Center(
              child: _buildImageWithResolution(
                image,
                resolution,
                pageFormat,
                documentFormat,
  ...
  PdfPageFormat _getPageFormat(
    ...
    switch (format) {
      ...
      case DocumentFormat.square:
        ...
        return PdfPageFormat(210 * PdfPageFormat.mm, 210 * PdfPageFormat.mm);
      ...
      case DocumentFormat.businessCard:
        ...
        return PdfPageFormat(85 * PdfPageFormat.mm, 55 * PdfPageFormat.mm);
    }
  }
  ...
  pw.Widget _buildImageWithResolution(
    ...
    final maxDimensions = _calculateMaxDimensionsForFormat(
      pageFormat,
      documentFormat,
    );
  ...
  Map<String, double> _calculateMaxDimensionsForFormat(
    PdfPageFormat pageFormat,
    DocumentFormat? documentFormat,
  ) {
    ...
    switch (documentFormat) {
      ...
      case DocumentFormat.square:
        ...
        final squareSize = usableWidth < usableHeight
            ? usableWidth
            : usableHeight;
  ...
  String _buildKeywords(
    ...
    final keywords = <String>[_getDocumentTypeName(documentType), 'scanned'];
    ...
    if (metadata != null) {
      if (metadata['keywords'] is String) {
        ...
        keywords.addAll(
          (metadata['keywords'] as List).map((k) => k.toString()),
        );
      }
