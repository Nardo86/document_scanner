...
void main() {
  group('Prioritized Navigation Tests', () {
    testWidgets('App launches with Quick Scan tab selected by default', (
      tester,
    ) async {
    ...
    testWidgets('Navigation destinations have correct icons and labels', (
      tester,
    ) async {
      // Given the app is built
      await tester.pumpWidget(const DocumentScannerShowcaseApp());
    ...
    testWidgets('Navigation works correctly between tabs', (tester) async {
      ...
      final navigationBarAfterFirstTap = tester.widget<NavigationBar>(
        find.byType(NavigationBar),
      );
      ...
      final navigationBarAfterThirdTap = tester.widget<NavigationBar>(
        find.byType(NavigationBar),
      );
